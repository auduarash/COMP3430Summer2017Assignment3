...
fat32: fat32_calculations.o utilities.o common.o main.o command_handlers.o program_logic.o fat32_impl.o
	$(GCC) $(CFLAGS) fat32_calculations.o utilities.o common.o main.o command_handlers.o program_logic.o fat32_impl.o -o fat32 
